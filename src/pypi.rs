...
impl Updatable for Pin {
    ...
    async fn fetch(&self, version: &GenericVersion) -> Result<GenericUrlHashes> {
        ...
        let hash = nixhash::from_str(&hash_str, Some("sha256"))
...
mod test {
    ...
    async fn test_pypi_update() -> Result<()> {
        ...
        assert_eq!(
            ...
            GenericUrlHashes {
                hash: nixhash::from_sri_str("sha256-OVOxWLe2kGQtaM1r6x1Z9uEFJvLuEKb7RjapE8yV5xg=").unwrap(),
    ...
    async fn test_pypi_max_version() -> Result<()> {
        ...
        assert_eq!(
            ...
            GenericUrlHashes {
                ...
                hash: nixhash::from_sri_str("sha256-OdCcZiclX885yTiTeZVmW2N3eZxPoUH2tIG8teamiKw=").unwrap(),
