...
fn upgrade_v5_pin(name: &str, raw_pin: &mut Map<String, Value>) -> Result<()> {
    ...
    if let Some(raw_hash) = raw_pin.remove("hash") {
        ...
        raw_pin.insert(
            "hash".into(),
            nixhash::from_str(&hash, Some("sha256"))?.to_string().into(),
        );
    }
            ...
            NixPins {
                pins: btreemap![
                    "nixos-mailserver".into() => Pin::Git {
                        ...
                        hashes: Some(git::OptionalUrlHashes { url: None, hash: nixhash::from_sri_str("sha256-hNhzLOp+dApEY15vwLAQZu+sjEQbJcOXCaSfAT6lpsQ=").unwrap() } ),
                    ...
                    "nixpkgs".into() => Pin::Git {
                        ...
                        hashes: Some(git::OptionalUrlHashes { url: Some("https://github.com/nixos/nixpkgs/archive/5c37ad87222cfc1ec36d6cd1364514a9efc2f7f2.tar.gz".parse().unwrap()), hash: nixhash::from_sri_str("sha256-a8GGtxn2iL3WAkY5H+4E0s3Q7XJt6bTOvos9qqxT5OQ=").unwrap() }),
                        frozen: Frozen::default(),
                    },
                    "streamlit".into() => Pin::PyPi {
                        ...
                        hashes: Some(GenericUrlHashes { url: "https://files.pythonhosted.org/packages/c3/9d/ac871992617220442832af12c3808716f4349ab05ff939d695fe8b542f00/streamlit-1.3.1.tar.gz".parse().unwrap(), hash: nixhash::from_sri_str("sha256-rex5NcnPd0uRFbJFbPL0jE9JufZxWal9sP4ig1fBr98=").unwrap() } ),
                        frozen: Frozen::default(),
                    },
